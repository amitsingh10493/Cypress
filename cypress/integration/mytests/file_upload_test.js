describe('file upload use cases', () => {
    ...
    it('simple file upload', ()=> {
        ...
        const yourFixturePath = 'IMG-20180305-WA0006.jpg';
    ...
    it('multiple files upload', ()=> {
        ...
        const yourFixturePath = 'IMG-20180305-WA0006.jpg';
        const yourFixturePath1 = '1558441211537_SeleniumNotes.pdf';
        const yourFixturePath2 = 'FreeCRMTestData.xlsx';
    ...
    it.skip('Header: Verify if state of the Cart is kept', () => {
